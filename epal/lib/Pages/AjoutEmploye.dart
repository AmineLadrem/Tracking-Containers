...
class AjoutEmploye extends StatefulWidget {
  static const String routeName = '/AjoutEmploye';

  @override
  State<AjoutEmploye> createState() => _AjoutEmployeState();
}

class _AjoutEmployeState extends State<AjoutEmploye> {
  ...
  final MotPass = TextEditingController();
